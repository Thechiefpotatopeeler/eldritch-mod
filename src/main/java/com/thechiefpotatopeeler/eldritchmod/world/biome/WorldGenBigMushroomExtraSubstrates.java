...
public class WorldGenBigMushroomExtraSubstrates extends WorldGenBigMushroom {
    private Block mushroomType;

    public WorldGenBigMushroomExtraSubstrates(Block block)
    {
        super(block);
        this.mushroomType = block;
    }

    public WorldGenBigMushroomExtraSubstrates()
    {
        super();
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 < 256)
        {
            ...
            else
            {
                ...
                if (block1 != Blocks.DIRT && block1 != Blocks.GRASS && block1 != Blocks.MYCELIUM && block1 != BlocksRegistry.MYCELIC_GRASS)
                {
                    return false;
                }
                else
